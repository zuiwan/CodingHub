# -*- coding: utf-8 -*-
__author__ = 'klb3713'
# https://gist.githubusercontent.com/klb3713/6077267/raw/236aa367075262ef776e66499313d891a629b482/web_test.py


import threading, time, httplib
from Library.Utils.time_util import get_now_time_str_ms
...
if __name__ == "__main__":
    post_datas = [
        '{"action":"add","zuser_id":"%s","psw":"password","user_name":"http://tv.sohu.com/20130526/n377096321.shtml"}' % (
            get_now_time_str_ms().replace('.', '')),
        '{"action":"update","zuser_id":"%s","psw":"password","nick_name":"http://tv.sohu.com/20130526/n377096321.shtml"}' % (
            get_now_time_str_ms().replace('.', '')),
        '{"action":"add","zuser_id":"%s","psw":"password","user_name":"http://tv.sohu.com/20130526/n377096321.shtml"}' % (
            get_now_time_str_ms().replace('.', '')),
        '{"action":"delete","zuser_id":"%s","psw":"password","nick_name":"http://tv.sohu.com/20130526/n377096321.shtml"}' % (
            get_now_time_str_ms().replace('.', ''))]
