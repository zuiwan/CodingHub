...
output_log_basepath=os.path.join(os.getcwd(), "APITestLog/")
class MyLogger():
    ...
    def _get_logger(self, logger_file, backup_file):
        ...
        Rthandler = RotatingFileHandler('%s/%s.log' % (dir_path, backup_file), maxBytes=5 * 1024 * 1024, backupCount=10)
